 ...
 */
final class Version20241020153232 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE blog_article (id INT AUTO_INCREMENT NOT NULL, author_id INT NOT NULL, title VARCHAR(100) NOT NULL, publication_date DATETIME NOT NULL, creation_date DATETIME NOT NULL, content LONGTEXT NOT NULL, keywords JSON NOT NULL, status VARCHAR(20) NOT NULL, slug VARCHAR(255) NOT NULL, cover_picture_ref VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
